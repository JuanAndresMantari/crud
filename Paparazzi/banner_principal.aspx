  ...
  <div class="main-wrapper">
    ...
    <header id="header">
      ...
      <section class="hsecond">
        <div id="logo"><a href="index.html"><img  src="image/logo.png" title="Polishop" alt="Polishop" class="logo" /></a></div>
        <div id="search">
    ...
    <div id="container">
      <div id="content">
        ...
        <section class="slider-wrapper">
          <div id="slideshow" class="nivoSlider"> <a class="nivo-imageLink" href=""><img src="./image/slider/slide-1.jpg" alt="slide-1" /></a> <a class="nivo-imageLink" href=""><img src="image/slider/slide-2.jpg" alt="slide-2" /></a> <a class="nivo-imageLink" href=""><img src="image/slider/slide-3.jpg" alt="slide-3" /></a> </div>
        </section>
...
$(document).ready(function() {
	$('#slideshow').nivoSlider();
        ...
        <div class="welcome">Bienvenido a Paparazzi Team</div>
        <p><strong>PANEL PRINCIPAL</strong></p>
       
         <section class="box">
          <div class="box-heading">VENTAS</div>
                ...
                <ul class="slides">
                  <li>
                    <div class="slide-inner">
                      ...
                      <div class="name"><a href="http://localhost/index.php?route=product/product&amp;product_id=43">Generar Venta Nueva</a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      ...
                      <div class="name"><a href="product.html">Listar Ventar</a></div>
                      <div class="price"> S/120.68 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
                  ...
                  <li>
                    <div class="slide-inner">
                      ...
                      <div class="price"> <span class="price-old">S/119.50</span><span class="price-new">$107.75</span> </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
                      <div class="clear"></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      ...
                      <div class="price"> S/1,177.00 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
                      <div class="clear"></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      ...
                      <div class="price"> S/1,177.00 </div>
                      <div class="cart">
                        <input t  ype="button" value="Add to Cart" class="button" />
                      </div>
                      <div class="clear"></div>
                    </div>
                  </li>
              ...
              <div class="flexslider featured_carousel">
                <ul class="slides">
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/lotto-sports-shoes-white-210x210.jpg" alt="Lotto Sports Shoes" /></a></div>
                      <div class="name"><a href="http://localhost/index.php?route=product/product&amp;product_id=43">Nuevo Producto</a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/iphone_1-210x210.jpg" alt="iPhone 4s" /></a></div>
                      <div class="name"><a href="product.html">Listar Producto</a></div>
                      <div class="price"> S/120.68 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/apple_cinema_30-210x210.jpg" alt="Apple Cinema 30&quot;" /></a></div>
                      <div class="name"><a href="product.html">Agregar producto</a></div>
                      <div class="price"> <span class="price-old">S/119.50</span><span class="price-new">$107.75</span> </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/sony_vaio_1-210x210.jpg" alt="Friendly Jewelry" /></a></div>
                      <div class="name"><a href="product.html">Editar Producto</a></div>
                      <div class="price"> S/1,177.00 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
          ...
          <section class="box">
          <div class="box-heading">PROVEEDORES</div>
          <div class="box-content">
            <div class="box-product">
              <div class="flexslider featured_carousel">
                <ul class="slides">
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/lotto-sports-shoes-white-210x210.jpg" alt="Lotto Sports Shoes" /></a></div>
                      <div class="name"><a href="http://localhost/index.php?route=product/product&amp;product_id=43">Nuevo Proveedor</a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/iphone_1-210x210.jpg" alt="iPhone 4s" /></a></div>
                      <div class="name"><a href="product.html">Listar Proveedores</a></div>
                      <div class="price"> S/120.68 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
          ...
          <section class="box">
          <div class="box-heading">Clientes</div>
          <div class="box-content">
            <div class="box-product">
              <div class="flexslider featured_carousel">
                <ul class="slides">
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/lotto-sports-shoes-white-210x210.jpg" alt="Lotto Sports Shoes" /></a></div>
                      <div class="name"><a href="http://localhost/index.php?route=product/product&amp;product_id=43">Nuevo Cliente</a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/iphone_1-210x210.jpg" alt="iPhone 4s" /></a></div>
                      <div class="name"><a href="product.html">Listar Clientes</a></div>
                      <div class="price"> S/120.68 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
              ...
              <div class="flexslider special_carousel_tab">
                <ul class="slides">
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/product/lotto-sports-shoes-white-210x210.jpg" alt="Lotto Sports Shoes" /></a></div>
                      <div class="name"><a href="http://localhost/index.php?route=product/product&amp;product_id=43">Lotto Sports Shoes</a></div>
                      <div class="price"> S/589.50 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
                      </div>
                      <div class="clear"></div>
