    ...
    <div id="container">
      ...
      <div id="content">
        ...
        <div class="login-content">
          <div class="left">
            <h2>Empleado</h2>
                <p>Inicio de sesión del cliente</p>
                <b>Correo Electrónico:</b><br>
                <input type="text" value="" name="email0">
                <br>
                <br>
                <b>Contraseña:</b><br>
                <input type="password" value="" name="password0">
                <br>
          ...
          <div class="right">
            ...
            <div class="content">
              ...
              <p>
                Al crear una cuenta, podrá comprar más rápido, estar actualizado sobre el estado de un pedido y realizar un seguimiento de los pedidos que haya realizado anteriormente.</p>
